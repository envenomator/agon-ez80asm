...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x86, S_ANY},
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xC6, S_NONE},
    // same set, without A register
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x86, S_ANY},
...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xA6, S_ANY},
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xE6, S_NONE},
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xA6, S_ANY},
};
operandlist_t operands_bit[] = {
    ...
    {false,RS_NONE, STATE_IMMEDIATE, RS_IXY, STATE_INDIRECT, OPTYPE_BIT, OPTYPE_INDIRECT_IXYd,   true, TRANSFORM_Y,      TRANSFORM_NONE, 0xCB, 0x46, S_ANY},
...
operandlist_t operands_call[] = {
    ...
    {true,RS_NONE, STATE_CC, RS_NONE, STATE_IMMEDIATE, OPTYPE_CC, OPTYPE_MMN,             false, TRANSFORM_CC,     TRANSFORM_NONE, 0x00, 0xC4, S_ANY},
};
...
// optimized set
    ...
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xFE, S_NONE},
...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xBE, S_ANY},
    // same set, without A register
    {false,RS_IR, NOREQ, RS_NONE, NOREQ, OPTYPE_IR,  OPTYPE_NONE,            true, TRANSFORM_IR0,    TRANSFORM_NONE, 0x00, 0xBC, S_NONE},
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ ,OPTYPE_INDIRECT_IXYd, OPTYPE_NONE, true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xBE, S_ANY},
};
...
// end optimized set
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x35, S_ANY}, 
...
// end optimized set
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x34, S_ANY}, 
...
// start optimized set
    ...
    {false,RS_NONE, STATE_IMMEDIATE, R_A, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_A,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x32, S_ANY},
    {false,RS_R, NOREQ, RS_R, NOREQ, OPTYPE_R, OPTYPE_R,                false, TRANSFORM_Y,      TRANSFORM_Z,    0x00, 0x40, S_NONE}, 
    {false,R_HL, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_HL, OPTYPE_INDIRECT_MMN,    false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x2A, S_ANY},
    {false,R_A, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_A, OPTYPE_INDIRECT_MMN,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3A, S_ANY}, 
    ...
    {false,RS_IXY, NOREQ, RS_NONE, NOREQ, OPTYPE_IXY, OPTYPE_MMN,             true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x21, S_ANY},  
    {false,RS_IXY, STATE_INDIRECT, RS_RR, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_RR,    true, TRANSFORM_NONE,   TRANSFORM_P,    0x00, 0x0F, S_ANY},  
...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x7E, S_ANY},
    {false,R_A, NOREQ, R_MB, NOREQ, OPTYPE_A, OPTYPE_MB,               false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x6E, S_NONE}, 
    {false,R_A, NOREQ, RS_R, NOREQ, OPTYPE_A,OPTYPE_REG_R,            false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x5F, S_NONE},
    {false,R_A, NOREQ, R_I, NOREQ, OPTYPE_A, OPTYPE_INDIRECT_BC,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x0A, S_ANY},  
    ...
    {false,R_HL, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_N,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x36, S_ANY},  
    {false,R_HL, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_RR,     false, TRANSFORM_NONE,   TRANSFORM_P,    0xED, 0x0F, S_ANY}, 
    ...
    {false,R_IX, NOREQ, R_IX, STATE_INDIRECT, OPTYPE_IX, OPTYPE_INDIRECT_IXd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x37, S_ANY}, 
    {false,R_IY, NOREQ, R_IY, STATE_INDIRECT, OPTYPE_IY, OPTYPE_INDIRECT_IYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x37, S_ANY}, 
    {false,R_IX, NOREQ, R_IY, STATE_INDIRECT, OPTYPE_IX, OPTYPE_INDIRECT_IYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x31, S_ANY}, 
    {false,R_IY, NOREQ, R_IX, STATE_INDIRECT, OPTYPE_IY, OPTYPE_INDIRECT_IXd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x31, S_ANY}, 
    {false,RS_IXY, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_IXY, OPTYPE_INDIRECT_MMN,    true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x2A, S_ANY},  
    {false,R_IX, STATE_INDIRECT, R_IX, NOREQ, OPTYPE_INDIRECT_IXd, OPTYPE_IX,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3F, S_ANY},
    {false,R_IY, STATE_INDIRECT, R_IY, NOREQ, OPTYPE_INDIRECT_IYd, OPTYPE_IY,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3F, S_ANY},
    {false,R_IX, STATE_INDIRECT, R_IY, NOREQ, OPTYPE_INDIRECT_IXd, OPTYPE_IY,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3E, S_ANY},
    {false,R_IY, STATE_INDIRECT, R_IX, NOREQ, OPTYPE_INDIRECT_IYd, OPTYPE_IX,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3E, S_ANY},
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, STATE_IMMEDIATE, OPTYPE_INDIRECT_IXYd, OPTYPE_N,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x36, S_ANY},  
    {false,RS_IXY, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_R,     true, TRANSFORM_NONE,   TRANSFORM_Z,    0x00, 0x70, S_ANY},  
    {false,R_MB, NOREQ, R_A, NOREQ, OPTYPE_MB, OPTYPE_A,               false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x6D, S_NONE}, 
    {false,RS_NONE, STATE_IMMEDIATE, RS_RR, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_RR,    false, TRANSFORM_NONE,   TRANSFORM_P,    0xED, 0x43, S_ANY},
    {false,RS_NONE, STATE_IMMEDIATE, R_SP, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_SP,    false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x73, S_ANY},
    ...
    {false,RS_R, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_R, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_Y,      TRANSFORM_NONE, 0x00, 0x46, S_ANY},
    {false,RS_RR, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_RR, OPTYPE_INDIRECT_IXYd,    true, TRANSFORM_P,      TRANSFORM_NONE, 0x00, 0x07, S_ANY},
    {false,RS_RR, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_RR, OPTYPE_INDIRECT_MMN,    false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x4B, S_ANY},
    {false,R_HL, STATE_IMMEDIATE, R_A, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_A,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x77, S_ANY},
...
// optimized set
    {false,RS_RR, NOREQ, R_IX, NOREQ, OPTYPE_RR, OPTYPE_IXd,             false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x02, S_ANY},
// end optimized set
    {false,R_IX, NOREQ, R_IX, NOREQ, OPTYPE_IX, OPTYPE_IXd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x32, S_ANY},
    {false,R_IY, NOREQ, R_IX, NOREQ, OPTYPE_IY, OPTYPE_IXd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x55, S_ANY},
    {false,R_IX, NOREQ, R_IY, NOREQ, OPTYPE_IX, OPTYPE_IYd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x54, S_ANY},
    {false,R_IY, NOREQ, R_IY, NOREQ, OPTYPE_IY, OPTYPE_IYd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x33, S_ANY},
    {false,RS_RR, NOREQ, R_IY, NOREQ, OPTYPE_RR, OPTYPE_IYd,             false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x03, S_ANY},
};
...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xB6, S_ANY},
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xF6, S_NONE},
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xB6, S_ANY},
};
...
operandlist_t operands_out[] = {
    ...
    {false,RS_NONE, STATE_IMMEDIATE, R_A, NOREQ, OPTYPE_INDIRECT_N, OPTYPE_A,       false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xD3, S_NONE},
}; 
...
operandlist_t operands_pea[] = {
    {false,R_IX, NOREQ, RS_NONE, NOREQ, OPTYPE_IXd, OPTYPE_NONE,           false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x65, S_ANY},
    {false,R_IY, NOREQ, RS_NONE, NOREQ, OPTYPE_IYd, OPTYPE_NONE,           false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x66, S_ANY},
};
...
operandlist_t operands_rl[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x16, S_ANY},
...
operandlist_t operands_rlc[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x06, S_ANY},
...
operandlist_t operands_rr[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x1E, S_ANY},
...
operandlist_t operands_rrc[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x0E, S_ANY},
...
operandlist_t operands_sbc[] = {
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x9E, S_ANY},
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xDE, S_NONE},
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x9E, S_ANY},
...
operandlist_t operands_sla[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x26, S_ANY},
...
operandlist_t operands_sra[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x2E, S_ANY},
...
operandlist_t operands_srl[] = {
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0xCB, 0x3E, S_ANY},
...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x96, S_ANY},
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xD6, S_NONE},
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,   true, TRANSFORM_NONE,   TRANSFORM_NONE,0x00, 0x96, S_ANY},
...
operandlist_t operands_tst[] = {
    ...
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x64, S_NONE},
...
// end optimized set
    ...
    {false,R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xAE, S_ANY},
    {false,R_A, NOREQ, RS_NONE, NOREQ, OPTYPE_A, OPTYPE_N,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xEE, S_NONE},
    ...
    {false,RS_IXY, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_NONE,  true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xAE, S_ANY},
};
