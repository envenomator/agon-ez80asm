...
// start optimized set
    {RS_RR, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_RR, OPTYPE_MMN,              true, TRANSFORM_P,      TRANSFORM_NONE, 0x00, 0x01, S_ANY},
    {RS_R, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_R, OPTYPE_N,                false, TRANSFORM_Y,      TRANSFORM_NONE, 0x00, 0x06, S_NONE},
    {R_A, NOREQ, R_HL, STATE_INDIRECT, OPTYPE_A,OPTYPE_INDIRECT_HL,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x7E, S_ANY},  
    {RS_NONE, STATE_IMMEDIATE, R_A, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_A,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x32, S_ANY},
    {RS_R, NOREQ, RS_R, NOREQ, OPTYPE_R, OPTYPE_R,                false, TRANSFORM_Y,      TRANSFORM_Z,    0x00, 0x40, S_NONE}, 
    {R_HL, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_HL, OPTYPE_INDIRECT_MMN,    false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x2A, S_ANY},
    {R_A, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_A, OPTYPE_INDIRECT_MMN,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3A, S_ANY}, 
    {RS_NONE, STATE_IMMEDIATE | STATE_INDIRECT, R_HL, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_HL,    false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x22, S_ANY},
    {R_HL, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_R,      false, TRANSFORM_NONE,   TRANSFORM_Z,    0x00, 0x70, S_ANY},  
    {R_A, NOREQ, R_DE, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_DE,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x1A, S_ANY},  
    {RS_RR, NOREQ, R_HL, STATE_INDIRECT, OPTYPE_RR, OPTYPE_INDIRECT_HL,     false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x07, S_ANY},
    {RS_RR, STATE_INDIRECT, R_A, NOREQ, OPTYPE_INDIRECT_RR, OPTYPE_A,      false, TRANSFORM_P,      TRANSFORM_NONE, 0x00, 0x02, S_ANY},
    {RS_IXY, NOREQ, RS_NONE, NOREQ, OPTYPE_IXY, OPTYPE_MMN,             true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x21, S_ANY},  
    {RS_IXY, STATE_INDIRECT, RS_RR, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_RR,    true, TRANSFORM_NONE,   TRANSFORM_P,    0x00, 0x0F, S_ANY},  
    {RS_NONE, STATE_INDIRECT | STATE_IMMEDIATE, RS_IXY, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_IXY,    true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x22, S_ANY}, 
// end optimized set
    {R_A, NOREQ, R_I, NOREQ, OPTYPE_A, OPTYPE_I,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x57, S_NONE}, 
    {R_A, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_A, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x7E, S_ANY},
    {R_A, NOREQ, R_MB, NOREQ, OPTYPE_A, OPTYPE_MB,               false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x6E, S_NONE}, 
    {R_A, NOREQ, RS_R, NOREQ, OPTYPE_A,OPTYPE_REG_R,            false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x5F, S_NONE},
    {R_A, NOREQ, R_I, NOREQ, OPTYPE_A, OPTYPE_INDIRECT_BC,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x0A, S_ANY},  
    {R_HL, NOREQ, R_I, NOREQ, OPTYPE_HL, OPTYPE_I,               false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0xD7, S_NONE}, 
    {R_HL, STATE_INDIRECT, R_IX, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_IX,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x3F, S_ANY},  
    {R_HL, STATE_INDIRECT, R_IY, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_IY,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x3E, S_ANY},  
    {R_HL, STATE_INDIRECT, RS_NONE, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_N,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x36, S_ANY},  
    {R_HL, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_RR,     false, TRANSFORM_NONE,   TRANSFORM_P,    0xED, 0x0F, S_ANY}, 
    {R_I, NOREQ, R_HL, NOREQ, OPTYPE_I, OPTYPE_HL,               false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0xC7, S_NONE},  
    {R_I, NOREQ, R_A, NOREQ, OPTYPE_I, OPTYPE_A,                false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x47, S_NONE},  
    {RS_IR, NOREQ, RS_IR, NOREQ, OPTYPE_IR, OPTYPE_IR,               true, TRANSFORM_IR3,     TRANSFORM_IR0, 0x00, 0x64, S_NONE}, 
    {RS_IR, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_IR, OPTYPE_N,                true, TRANSFORM_IR3,     TRANSFORM_NONE,0x00, 0x26, S_NONE}, 
    {RS_IR, NOREQ, RS_AE, NOREQ, OPTYPE_IR, OPTYPE_R_AEONLY,         true, TRANSFORM_IR3,     TRANSFORM_Z,   0x00, 0x60, S_NONE}, 
    {R_IX, NOREQ, R_HL, STATE_INDIRECT, OPTYPE_IX, OPTYPE_INDIRECT_HL,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x37, S_ANY}, 
    {R_IY, NOREQ, R_HL, STATE_INDIRECT, OPTYPE_IY, OPTYPE_INDIRECT_HL,     false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x31, S_ANY}, 
    {R_IX, NOREQ, R_IX, STATE_INDIRECT, OPTYPE_IX, OPTYPE_INDIRECT_IXd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x37, S_ANY}, 
    {R_IY, NOREQ, R_IY, STATE_INDIRECT, OPTYPE_IY, OPTYPE_INDIRECT_IYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x37, S_ANY}, 
    {R_IX, NOREQ, R_IY, STATE_INDIRECT, OPTYPE_IX, OPTYPE_INDIRECT_IYd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x31, S_ANY}, 
    {R_IY, NOREQ, R_IX, STATE_INDIRECT, OPTYPE_IY, OPTYPE_INDIRECT_IXd,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x31, S_ANY}, 
    {RS_IXY, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_IXY, OPTYPE_INDIRECT_MMN,    true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x2A, S_ANY},  
    {R_IX, STATE_INDIRECT, R_IX, NOREQ, OPTYPE_INDIRECT_IXd, OPTYPE_IX,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3F, S_ANY},
    {R_IY, STATE_INDIRECT, R_IY, NOREQ, OPTYPE_INDIRECT_IYd, OPTYPE_IY,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3F, S_ANY},
    {R_IX, STATE_INDIRECT, R_IY, NOREQ, OPTYPE_INDIRECT_IXd, OPTYPE_IY,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3E, S_ANY},
    {R_IY, STATE_INDIRECT, R_IX, NOREQ, OPTYPE_INDIRECT_IYd, OPTYPE_IX,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x3E, S_ANY},
    {RS_IXY, STATE_INDIRECT, RS_NONE, STATE_IMMEDIATE, OPTYPE_INDIRECT_IXYd, OPTYPE_N,     true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x36, S_ANY},  
    {RS_IXY, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_IXYd, OPTYPE_R,     true, TRANSFORM_NONE,   TRANSFORM_Z,    0x00, 0x70, S_ANY},  
    {R_MB, NOREQ, R_A, NOREQ, OPTYPE_MB, OPTYPE_A,               false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x6D, S_NONE}, 
    {RS_NONE, STATE_IMMEDIATE, RS_RR, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_RR,    false, TRANSFORM_NONE,   TRANSFORM_P,    0xED, 0x43, S_ANY},
    {RS_NONE, STATE_IMMEDIATE, R_SP, NOREQ, OPTYPE_INDIRECT_MMN, OPTYPE_SP,    false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x73, S_ANY},
    {R_R, NOREQ, R_A, NOREQ, OPTYPE_REG_R, OPTYPE_A,            false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x4F, S_NONE},
    {RS_R, NOREQ, R_HL, STATE_INDIRECT, OPTYPE_R, OPTYPE_INDIRECT_HL,      false, TRANSFORM_Y,      TRANSFORM_NONE, 0x00, 0x46, S_ANY},
    {RS_AE, NOREQ, RS_IR, NOREQ, OPTYPE_R_AEONLY, OPTYPE_IR,         true, TRANSFORM_Y,      TRANSFORM_IR0,  0x00, 0x44, S_NONE},
    {RS_R, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_R, OPTYPE_INDIRECT_IXYd,     true, TRANSFORM_Y,      TRANSFORM_NONE, 0x00, 0x46, S_ANY},
    {RS_RR, NOREQ, RS_IXY, STATE_INDIRECT, OPTYPE_RR, OPTYPE_INDIRECT_IXYd,    true, TRANSFORM_P,      TRANSFORM_NONE, 0x00, 0x07, S_ANY},
    {RS_RR, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_RR, OPTYPE_INDIRECT_MMN,    false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x4B, S_ANY},
    {R_HL, STATE_IMMEDIATE, R_A, NOREQ, OPTYPE_INDIRECT_HL, OPTYPE_A,      false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x77, S_ANY},
    {R_SP, NOREQ, R_HL, NOREQ, OPTYPE_SP, OPTYPE_HL,              false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xF9, S_ANY},
    {R_SP, NOREQ, RS_IXY, NOREQ, OPTYPE_SP, OPTYPE_IXY,              true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xF9, S_ANY},
    {R_SP, NOREQ, RS_NONE, STATE_IMMEDIATE, OPTYPE_SP, OPTYPE_MMN,              true, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0x31, S_ANY},
    {R_SP, NOREQ, RS_NONE, STATE_IMMEDIATE | STATE_INDIRECT, OPTYPE_SP, OPTYPE_INDIRECT_MMN,    false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x7B, S_ANY},
};
...
// optimized set
    {RS_RR, NOREQ, R_IX, NOREQ, OPTYPE_RR, OPTYPE_IXd,             false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x02, S_ANY},
// end optimized set
    {R_IX, NOREQ, R_IX, NOREQ, OPTYPE_IX, OPTYPE_IXd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x32, S_ANY},
    {R_IY, NOREQ, R_IX, NOREQ, OPTYPE_IY, OPTYPE_IXd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x55, S_ANY},
    {R_IX, NOREQ, R_IY, NOREQ, OPTYPE_IX, OPTYPE_IYd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x54, S_ANY},
    {R_IY, NOREQ, R_IY, NOREQ, OPTYPE_IY, OPTYPE_IYd,             false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x33, S_ANY},
    {RS_RR, NOREQ, R_IY, NOREQ, OPTYPE_RR, OPTYPE_IYd,             false, TRANSFORM_P,      TRANSFORM_NONE, 0xED, 0x03, S_ANY},
};
...
operandlist_t operands_out[] = {
    {R_BC, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_BC, OPTYPE_R,      false, TRANSFORM_NONE,   TRANSFORM_Y,    0xED, 0x41, S_NONE},
    {R_C, STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_C, OPTYPE_R,       false, TRANSFORM_NONE,   TRANSFORM_Y,    0xED, 0x41, S_NONE},
    {RS_NONE, STATE_IMMEDIATE, R_A, NOREQ, OPTYPE_INDIRECT_N, OPTYPE_A,       false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xD3, S_NONE},
}; 
operandlist_t operands_out0[] = {
    {RS_NONE, STATE_IMMEDIATE | STATE_INDIRECT, RS_R, NOREQ, OPTYPE_INDIRECT_N, OPTYPE_R,       false, TRANSFORM_NONE,   TRANSFORM_Y,    0xED, 0x01, S_NONE},
};
...
operandlist_t operands_pea[] = {
    {R_IX, NOREQ, RS_NONE, NOREQ, OPTYPE_IXd, OPTYPE_NONE,           false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x65, S_ANY},
    {R_IY, NOREQ, RS_NONE, NOREQ, OPTYPE_IYd, OPTYPE_NONE,           false, TRANSFORM_NONE,   TRANSFORM_NONE, 0xED, 0x66, S_ANY},
};
operandlist_t operands_pop[] = {
    ...
    {R_AF, NOREQ, RS_NONE, NOREQ, OPTYPE_AF, OPTYPE_NONE,            false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xF1, S_ANY},
...
operandlist_t operands_push[] = {
    ...
    {R_AF, NOREQ, RS_NONE, NOREQ, OPTYPE_AF, OPTYPE_NONE,            false, TRANSFORM_NONE,   TRANSFORM_NONE, 0x00, 0xF5, S_ANY},
...
operandlist_t operands_ret[] = {
    ...
    {RS_NONE, STATE_CC, RS_NONE, NOREQ, OPTYPE_CC, OPTYPE_NONE,            false, TRANSFORM_CC,     TRANSFORM_NONE, 0x00, 0xC0, S_LIL | S_LIS},
};
